...
<Hint style="info">
For payment integration, you must first create an account from the i'mport Admin [**Sign Up**](https://admin.portone.io/) page.
...
1. Log in to [**PortOne Admin Console**](https://admin.portone.io/) -> **Merchant account**
...
<Figure src="/gitbook-assets/en/image (217).png" caption="Log in to PortOne Admin Console -> Merchant account -> Select My ID - API Keys" />
